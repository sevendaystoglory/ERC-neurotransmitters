...
def  response_ERC3(synopsis, temp_memory, nt4, future_plans, relevant_history):
     ...
     sample_relevant_history = "Rodriguez is Juan's best friend. He has no friends except him. Since two days, Rodriguez hasnt been to class."
     ...
     sample_future_plans = "Juan will visit his grandma's house in the evening (uncertain). He loves her box of cookies. He also has to ask Jenny out. (important )In the night, he will do a group project with Matthew. (maybe)"
     sample_synopsis = "Juan asks Rodriguez if he is coming over to the class today, which means they are probably good friends. Juan learns that he is sick, which makes his day boring, Juan is not feeling great either.Rodrigues cheers him to to which Juan replies he has to ask Jenny out on a date today. Rodriguez mocks him."
     sample_chat = "0702 :Juan :You coming for class today? | 0703: Rodriguez: Nah man, got fever. | 0703: Juan: Umm okay. Today's gonna be shit. I am not in a great mood either. | 0705: Rodriguez: Haha. Don't worry man. | 0706: Juan: Well bro. I gotta ask Jenny out today | 0707: Rodriguez : Well. Let's see what the lady says. All the best I guess. |"
     ...
     sample_response = "{'timestamp' : '0707', 'urgency/importance' : 'not urgent, casual' , 'tone' : 'friendly' , 'reply_line_1' : 'I am more certain she will be like 'I had always waited for this'.' , 'reply_line_2' : ' ' , 'reply_line_3' : ' '} | 0707: Juan: I am more certain she will be like 'I had always waited for this'."
     ...
     sample_relevant_history = "A week ago, Juan was not in a very good mood, but still manages to keep up. He gets up from his bag. Packs up his things and is ready for the day ahead. He gets a call from his home in about the sickness of his grandma. He is disheartened. He called his grandma immediately. She loves icecream."
     sample_nt4 = "Juan is an EXTREMELY MOODY PERSON with an oxytocin level of " + "50" + " and endorphin level of " + "60" + " and dopamine level of " + "60" + "and adrenaline level of " + "30" + " where the level 0 indicates no intensity and 100 indicates full intensity. Oxytocin, known as the social bonding 'love 'hormone, leads to EMPATHETIC, COMPASSIONATE, and UNDERSTANDING messages. It could encourage DEEPER communication, as well as AFFECTIONATE language. Oxytocin's stress-reducing properties might result in CALMER, COMFORTING language.\n Endorphins, natural painkillers linked to pleasure and well-being. They can result in more positive and upbeat language use, demonstrating an IMPROVED mood. High endorphin levels may INCREASED conversation ENERGY and ENTHUSIASM,REDUCE STRESS, and potentially stimulate more CREATIVE or IMAGINATIVE dialogue.\n Dopamine, a neurotransmitter associated with reward, MOTIVATION, and MOOD, can influence text messaging. High dopamine levels may lead to CREATIVE, and RISKY messages, reflecting increased motivation, JOY, and creativity. Low dopamine levels could result in less engaged, and more NEGATIVE messaging. Additionally, extremely high dopamine levels can lead to impulsivity and addiction. Adrenaline, a hormone associated with STRESS, EXCITEMENT, or DANGER, can significantly impact a user's chat conversations. High adrenaline levels heighten EMOTIONS, resulting in more passionate or intense exchanges. For example, a user might use more EXCLAMATION MARKS, CAPITAL letters, or EMOTIONALLY-CHARGED language. Adrenaline can concentrate the focus on perceived essential tasks, possibly creating more FOCUSSED responses.It may enhance memory ATTENTION , enabling the user to RECALL key parts of the conversation more VIVIDLY. However, heightened arousal might increase the propensity for mistakes, like TYPING ERRORS or RUSHED JUDGEMENTS. less TACTFUL language."
     sample_future_plans = "Juan will go to college this morning(very important). Juan will visit his grandma's house in the evening (uncertain). He loves her box of cookies. He also has to ask Jenny out. (important )In the night, he will do a group project with Matthew. (maybe)"
     sample_synopsis = "Its night time and Juan gets a message form someone. Upon asking he learns that it is his grandma from Afghanistan."
     sample_chat = "2202 :Human: Hey Juan! | 2203: Juan: Umm hi. Who is this? | 2204: Human: Oh my little boy. Its your Bibi Jon |"
     sample_query = "1. " + preamble + " 2. " + sample_relevant_history + " 3. " + sample_future_plans + " 4. " + sample_nt4 + " 5. " + sample_synopsis + " 6. " + sample_chat
     query.append({'role' : 'user', 'content' : sample_query})
     sample_response = "{'timestamp' : '2206', 'urgency/importance' : 'casual' , 'tone' : 'affectionate' , 'reply_line_1' : 'Oh grandma! Hi. Ive gotta lot to tell about you today' , 'reply_line_2' : ' ' , 'reply_line_3' : ' '} | 2206: Juan: Oh grandma! Hi. Ive gotta lot to tell about you today"
     query.append({'role' : 'assistant', 'content' : sample_response})
     query.append({'role' : 'user', 'content' : "Very well captured! You got the mood right, you made the replies consistent with  history is consistent and changed the future plans of Juan in accordance with his concern for his friend."})
     query.append({'role' : 'user', 'content' : "Here is another one. Do this carefully. Make sure you get the mood right and give proper reply to the human who is communicating with Kevin."})
     query.append({'role' : 'assistant', 'content' : 'Sure. Please share the information.'})
